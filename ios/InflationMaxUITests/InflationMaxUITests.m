...
- (void)testExample {
  ...
  XCUIElement *currentInflationRateTextField = app.textFields[@"Current inflation rate"];
  ...
  [/*@START_MENU_TOKEN@*/app.otherElements[@"Calculate Inflation"]/*[["app","[",".otherElements matchingIdentifier:@\"10 years from now you will still have $1000 but it will only be worth $0. But if you invest it at a risk free rate you will have $0. Which will be worth $0 after inflation. A difference of: $0. Calculate Inflation\"].otherElements[@\"Calculate Inflation\"]",".otherElements[@\"Calculate Inflation\"]"],[[[-1,0,1]],[[-1,3],[1,2]]],[0,0]]@END_MENU_TOKEN@*/ tap];
